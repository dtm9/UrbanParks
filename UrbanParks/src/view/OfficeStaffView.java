...
public class OfficeStaffView extends AbstractView {
    ...
    /**
     * Public method to launch the GUI for Office Staff accounts. This is the
     * only public method and it drives all other code in this module.
     * 
     * @author Dylan Miller
     */
    @Override
    public void launchGUI() {
        // TODO all necessary initialization, then call another method to print
        // first menu. That method should call more methods not return until the
        // end.
        // TODO some kind of exit/cleanup method after the call stack pops back
        // here at the end.
        mainMenu();
    }
